...
function Scroller() {
  ...
  function offsetValue(i) {
    var item_offset = window.scrollY >= i.offsetTop - window.innerHeight + 200 && window.scrollY <= i.offsetTop + i.offsetHeight - 250;
    return item_offset;
  }
...
/* map */
var position = new naver.maps.LatLng(36.981359181195, 127.93438224276);
